      ...
      <div className="relative pl-6 border-l-2 border-emerald-500/40 space-y-6">
        {timeline.map((step, idx) => (
          <div key={idx} className="relative group">
            {/* Step Node Icon */}
            <div className="absolute -left-[31px] top-0.5 w-6 h-6 rounded-full bg-white border-2 border-emerald-600 flex items-center justify-center text-emerald-600 shadow-xs">
            ...
            <div className="bg-slate-50 p-3 rounded-xl border border-slate-200 space-y-1">
              ...
              <span className="text-[10px] font-bold text-emerald-700 uppercase tracking-wider inline-block">
                Status: {step.status}
              </span>
            </div>
          </div>
